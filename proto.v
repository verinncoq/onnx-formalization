...
commented out "syntax = ""proto2"";"
commented out "package onnx"
commented out "option optimize_for = LITE_RUNTIME";
commented out "optional GraphProto g = 6;          // graph" (in message AttributeProto, removed nested subgraphs)
commented out "repeated GraphProto graphs = 11;    // list of graph" (in message AttributeProto, removed nested subgraphs)
in message TypeProto: removed TypeProto type in Sequence , Map and Optional. Replaced with string type, to fill in Error message
*)
